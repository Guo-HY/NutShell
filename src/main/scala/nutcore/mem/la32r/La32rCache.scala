...
abstract class La32rCacheBundle(implicit cacheConfig: La32rCacheConfig) extends Bundle with HasNutCoreParameter with HasLa32rCacheConst
abstract class La32rCacheModule(implicit cacheConfig: La32rCacheConfig) extends Module with HasNutCoreParameter with HasLa32rCacheConst with HasNutCoreLog

trait HasLa32rCacheIO {
  implicit val cacheConfig: La32rCacheConfig
  class La32rCacheIO(implicit val cacheConfig: La32rCacheConfig) extends Bundle with HasNutCoreParameter with HasLa32rCacheConst {
