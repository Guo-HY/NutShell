...
trait HasLa32rTLBConst extends HasNutCoreParameter {
...
class La32rTLBCSRReadlIO(implicit val la32rMMUConfig: La32rMMUConfig) extends NutCoreBundle with HasLa32rTLBConst with HasLa32rMMUConst {
...
class La32rTLBEntry(implicit val la32rMMUConfig: La32rMMUConfig) extends NutCoreBundle with HasLa32rTLBConst {
  val tlbhi = new TLBHIStruct
  val tlblo0 = new TLBLOStruct
  val tlblo1 = new TLBLOStruct
}

class La32rTLB(implicit val la32rMMUConfig: La32rMMUConfig) extends NutCoreModule with HasLa32rTLBConst with HasLa32rCSRConst with HasLa32rMMUConst with HasMemAccessMaster {
